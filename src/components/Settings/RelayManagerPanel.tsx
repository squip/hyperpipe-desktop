      ...
      <>
        <div className="rounded-lg border border-border/50 bg-muted/40 p-4 space-y-3">
          <div className="flex items-center justify-between gap-2">
            <div>
              <div className="font-semibold">Hyperpipe relays</div>
        ...
        <Dialog open={webCtaOpen} onOpenChange={setWebCtaOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Hyperpipe relays</DialogTitle>
              <DialogDescription>
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new Hyperpipe relay on this device.</DialogDescription>
          </DialogHeader>
          <form className="space-y-4" onSubmit={handleCreate}>
            ...
            <div className="flex items-center justify-between rounded-md border px-3 py-2">
              <div className="space-y-0.5">
                ...
                <div className="text-xs text-muted-foreground">
                  Anyone can join without approval (via Hyperpipe join flow).
                </div>
              </div>
      ...
      <Dialog open={joinOpen} onOpenChange={setJoinOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Join an existing Hyperpipe relay by key or public identifier.</DialogDescription>
          </DialogHeader>
