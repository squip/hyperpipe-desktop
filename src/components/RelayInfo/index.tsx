...
import { APP_SHARE_BASE_URL } from '@/constants'
...
function RelayControls({ url }: { url: string }) {
  ...
  const handleCopyShareableUrl = () => {
    const shareUrl = new URL('/', APP_SHARE_BASE_URL)
    shareUrl.searchParams.set('r', url)
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <SaveRelayDropdownMenu itemUrls={[url]} bigButton />
    </div>
  )
}
