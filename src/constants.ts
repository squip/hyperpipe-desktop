...
export const LEGACY_DEFAULT_DESKTOP_PRIMARY_COLUMN_WIDTH = 1067
export const LEGACY_DEFAULT_DESKTOP_SECONDARY_COLUMN_WIDTH = 586
export const LEGACY_DEFAULT_DESKTOP_COLUMN_TOTAL_WIDTH =
  LEGACY_DEFAULT_DESKTOP_PRIMARY_COLUMN_WIDTH + LEGACY_DEFAULT_DESKTOP_SECONDARY_COLUMN_WIDTH
export const LEGACY_DEFAULT_DESKTOP_PRIMARY_COLUMN_WIDTH_PERCENT =
  (LEGACY_DEFAULT_DESKTOP_PRIMARY_COLUMN_WIDTH / LEGACY_DEFAULT_DESKTOP_COLUMN_TOTAL_WIDTH) * 100

export const DEFAULT_DESKTOP_PRIMARY_COLUMN_WIDTH = 1140
export const DEFAULT_DESKTOP_SECONDARY_COLUMN_WIDTH = 620
